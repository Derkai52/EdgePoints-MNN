#ifndef EDGEPOINTS_H_
#define EDGEPOINTS_H_
...
{
    /**
    * @brief This class is the C++ implementation of EdgePoints:Accelerated Features deep learning model optimized using TensorRT for super fast keypoint detection.
