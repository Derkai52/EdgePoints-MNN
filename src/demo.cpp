...
public:
    EdgePointsNode(ros::NodeHandle& nh)
        : it_(nh)
    {
        sub1_ = it_.subscribe("/camera/infra1/image_rect_raw", 1, &EdgePointsNode::imageCallback1, this);
        sub2_ = it_.subscribe("/camera/infra2/image_rect_raw", 1, &EdgePointsNode::imageCallback2, this);
